        ...
        <section className="section-cardswrap-information" id="sobremim">
            ...
            <div className="section-cardswrap-information-content-about">
                ...
                <div className="section-cardswrap-information-content-right">
                    ...
                    <p><b>Tenho 17 anos.</b> Além de programar gosto de praticar alguns esportes como basquete e futebol, gosto de jogar poker e truco, tocar muita guitarra e de sair com amigos e familiares. Sempre tive vontade de desenvolver aplicativos e jogos e quando comecei com HTML5 em 2020 eu me apaixonei.</p>
                </div>
            </div>
        </section>
